<?php
require_once("MODEL/DAO/DaoEstadoPregunta.php");
require_once("MODEL/DAO/DaoPreguntas.php");
require_once("MODEL/DTO/DtoEstadoPregunta.php");
require_once("MODEL/DTO/DtoPregunta.php");
require_once("MODEL/DAO/DaoTrabajoCatgoria.php");
require_once("MODEL/DTO/DtoTrabajoCatgoria.php");
$dao=new DaoEstadoPregunta();
$dto=new DtoEstadoPregunta(1,"hola prueba");
//$dao->crear($dto);
...
<header class="col col-lg-12 page-header">header</header>
    <div class="col col-lg-5 conta" id="areaFormulario">
        ...
        <div class="col-lg-12 ">
            <form role="form" id="frmCrearPregunta" >
                <h3 class="control-label">Crear Pregunta</h3>

                <div class="form-group">
                    <label for= "txtPregunta" class="control-label">Pregunta</label>
                    <textarea id="txtPregunta" type="text" maxlength="200" required placeholder="Escribe tu pregunta aquí" class="form-control"></textarea>
                </div>

                <div class="form-group">
                    <label for="cmbCategorias" class="control-label">Tipo de Trabajo</label>
...
foreach($dtt->traerTodos() as $t){
  echo '<option class="text-info" value="'.$t->getIdTrabajo().'">'.$t->getDescripcion().'</option>';
